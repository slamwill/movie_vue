...
export default {
    ...
    async asyncData ({app, params, query}) {
        // const result = await app.$axios.$get( 'http://avtiger.1778mao.com:8092/api/self',{params:{page:query.page || 1}});
        const result = await app.$axios.$get( state.url+'/api/self',{params:{page:query.page || 1}});
        return {
            videos: result.data,
            form:{
                total: result.total,
